Engine_ominousefm2 : CroneEngine {
	...
	*new {arg context, doneCallback;
	...
	arg out, out_x, audio_in, gate=0, pit=48, contour=0.4, detune=0.25, level1=0.5,  level2=0.5, ratio1=0.5, ratio2=0.5, fm1=0.1, fm2=0.1, fb=0, fbx=0, filter_mode=0, cutoff=0.5, reson=0, strength=0.0, env=0.5, rotate=0.2, space=0.5, mul=0.5, add=0, revtime=0.5, drywet=0.1, damping=0.3, hp=0.0, freeze=0, diffusion=0.625, fm1_mod_sel=0, fm1_mod_freq=0.5, fm1_mod_amt=0.0, detune_mod_sel=0, detune_mod_freq=0.5, detune_mod_amt=0.0, ratio1_mod_sel=0, ratio1_mod_freq=0.5, ratio1_mod_amt=0.0;
